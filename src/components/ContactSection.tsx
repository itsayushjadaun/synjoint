...
const ContactSection = () => {
  ...
  const contactInfo = [
    {
      icon: <MapPin className="h-6 w-6 text-synjoint-blue dark:text-synjoint-lightblue" />,
      title: "Address",
      details: "G-60 Ajmer Industrial Area, Palra, Ajmer, Rajasthan 305001"
    },
    {
      icon: <Mail className="h-6 w-6 text-synjoint-blue dark:text-synjoint-lightblue" />,
      title: "Email",
      details: "synjoint.tech@gmail.com"
    },
    {
      icon: <Phone className="h-6 w-6 text-synjoint-blue dark:text-synjoint-lightblue" />,
      title: "Phone/WhatsApp",
      details: "+91 9928822313"
    }
  ];
            ...
            >
              ...
              <div className="pt-6">
                ...
                <div className="flex space-x-4">
                  <a href="#" className="p-3 bg-white dark:bg-gray-800 rounded-full shadow-md hover:bg-synjoint-blue hover:text-white dark:hover:bg-synjoint-blue transition-colors">
